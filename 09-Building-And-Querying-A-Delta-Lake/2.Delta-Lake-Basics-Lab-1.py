...
# MAGIC %fs ls /user/michel.araujo@artefact.com/delta/customer_counts/
...
newCustomerCounts = newDataDF.groupBy("Country", "CustomerID").count()
newCustomerCounts= newCustomerCounts.withColumnRenamed("count", "total_orders")
